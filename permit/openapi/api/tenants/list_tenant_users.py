...
from ...models.paginated_result_user_read import PaginatedResultUserRead
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/facts/{proj_id}/{env_id}/tenants/{tenant_id}/users".format(
...
def _build_response(
    *, response: httpx.Response
    ...
    return Response(
        ...
        parsed=parse_response(response=response, model=PaginatedResultUserRead),
    )
