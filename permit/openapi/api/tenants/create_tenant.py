...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, TenantRead]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, TenantRead]]:
    return Response(
