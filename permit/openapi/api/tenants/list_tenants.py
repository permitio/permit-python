...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/facts/{proj_id}/{env_id}/tenants".format(client.base_url, proj_id=proj_id, env_id=env_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, List[TenantRead]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = TenantRead.parse_obj(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, List[TenantRead]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    per_page: Union[Unset, None, int] = 30,
    permit_session: Union[Unset, str] = UNSET,
) -> Response[Union[HTTPValidationError, List[TenantRead]]]:
    """List Tenants
...
def sync(
    ...
    *,
    ...
    per_page: Union[Unset, None, int] = 30,
    permit_session: Union[Unset, str] = UNSET,
) -> Optional[Union[HTTPValidationError, List[TenantRead]]]:
    """List Tenants
