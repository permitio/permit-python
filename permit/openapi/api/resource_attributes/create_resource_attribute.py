...
from ...models.resource_attribute_create import ResourceAttributeCreate
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: ResourceAttributeCreate,
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, ResourceAttributeRead]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, ResourceAttributeRead]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (ResourceAttributeCreate):  Example: {'key': 'private', 'type': 'bool',
