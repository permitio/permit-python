...
def _parse_response(*, response: httpx.Response) -> Optional[Union[HTTPValidationError, UserData]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[HTTPValidationError, UserData]]:
    return Response(
