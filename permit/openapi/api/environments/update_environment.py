...
def _get_kwargs(
    ...
    *,
    ...
    json_body: EnvironmentUpdate,
    permit_session: Union[Unset, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}/v2/projects/{proj_id}/envs/{env_id}".format(client.base_url, proj_id=proj_id, env_id=env_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[EnvironmentRead, HTTPValidationError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[EnvironmentRead, HTTPValidationError]]:
    return Response(
