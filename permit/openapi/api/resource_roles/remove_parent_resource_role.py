...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v2/schema/{proj_id}/{env_id}/resources/{resource_id}/roles/{role_id}/parents/{parent_role_id}".format(
        client.base_url,
        proj_id=proj_id,
        env_id=env_id,
...
def sync_detailed(
    ...
    *,
    ...
    We can say the `role_id` **not longer extends** `parent_role_id` or **no longer inherits** from
    `parent_role_id`.
