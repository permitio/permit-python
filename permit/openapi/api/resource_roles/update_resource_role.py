...
from ...models.resource_role_update import ResourceRoleUpdate
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (ResourceRoleUpdate):  Example: {'description': 'the maintainer role can read
            from the repo and push changes', 'permissions': ['push']}.
