...
from permit.openapi.api.users import assign_role_to_user, create_user, delete_user, get_user, list_users, \
    unassign_role_from_user, update_user
...
class UsersApi(Api):
    def __init__(self, *args, **kwargs):
        ...
        self.async_unassign_role_from_user = functools.partial(unassign_role_from_user.asyncio)
