...
#   timestamp: 2025-09-17T12:48:00+00:00
...
class AuditLogReplayRequest(BaseModel):
    class Config:
        extra = Extra.allow
...
class AuditLogReplayResponse(BaseModel):
    class Config:
        extra = Extra.allow
...
class BillingTierType(str, Enum):
    free = 'free'
    startup = 'startup'
    pro = 'pro'
...
class ConditionSet(BaseModel):
    ...
    attribute: str = Field(
        ..., description='The attribute of the condition set.', title='Attribute'
    )
    operator: str = Field(
        ..., description='The operator of the condition set.', title='Operator'
    )
    value: str = Field(
        ..., description='The value of the condition set.', title='Value'
    )
...
class PaginatedResultGroupReadSchema(BaseModel):
    ...
    data: List[GroupReadSchema] = Field(
...
class PdpValues(BaseModel):
    ...
    OPA_DECISION_LOG_ENABLED: bool = Field(..., title='Opa Decision Log Enabled')
...
class PolicyGuardRuleCreate(BaseModel):
    class Config:
        extra = Extra.allow
...
class PolicyGuardRuleItem(BaseModel):
    class Config:
        extra = Extra.allow
...
class PolicyGuardRuleRead(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    scope_id: UUID = Field(
        ..., description='The unique identifier of the policy guard.', title='Scope Id'
    )
    organization_id: UUID = Field(
        ...,
...
class PolicyGuardScopeAssociate(BaseModel):
    class Config:
        extra = Extra.allow
...
class PolicyGuardScopeDetail(BaseModel):
    class Config:
        extra = Extra.allow
...
class PolicyGuardScopeDetailCreate(BaseModel):
    class Config:
        extra = Extra.allow
...
class PolicyGuardScopeRead(BaseModel):
    class Config:
        extra = Extra.allow

    key: str = Field(
        ..., description='The unique key of the policy guard scope.', title='Key'
    )
    id: UUID = Field(..., description='Unique id of the ScopeConfig', title='Id')
    organization_id: UUID = Field(
        ...,
...
class RelationshipTupleDeleteBulkOperation(BaseModel):
    ...
    idents: List[RelationshipTupleDelete] = Field(
        ...,
...
class ResourceInstanceDetailedRead(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    relationships: List[RelationshipTupleBlockRead] = Field(
        ...,
...
class DataGeneratorLibSchemasSchemaOpalDataConditionSetData(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataDerivationSettings(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataDerivedRoleRule(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataResourceInstanceAttributeData(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataRoleData(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataTenantData(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataUserData(BaseModel):
    class Config:
        extra = Extra.allow
...
class PermitBackendSchemasSchemaOpalDataConditionSetData(BaseModel):
    class Config:
        extra = Extra.allow
...
class PermitBackendSchemasSchemaOpalDataDerivedRoleRule(BaseModel):
    class Config:
        extra = Extra.allow
...
class PermitBackendSchemasSchemaOpalDataResourceInstanceAttributeData(BaseModel):
    class Config:
        extra = Extra.allow
...
class PermitBackendSchemasSchemaOpalDataRoleData(BaseModel):
    class Config:
        extra = Extra.allow
...
class PermitBackendSchemasSchemaOpalDataTenantData(BaseModel):
    class Config:
        extra = Extra.allow
...
class PermitBackendSchemasSchemaOpalDataUserData(BaseModel):
    class Config:
        extra = Extra.allow
...
class OrganizationRead(BaseModel):
    ...
    usage_limits: Optional[UsageLimits] = Field(
        default_factory=lambda: UsageLimits.parse_obj(
            {'mau': 5000, 'tenants': 50, 'billing_tier': 'trial'}
        ),
...
class PaginatedResultResourceInstanceDetailedRead(BaseModel):
    ...
    data: List[ResourceInstanceDetailedRead] = Field(
...
class RelationshipTupleDetailedRead(BaseModel):
    class Config:
        extra = Extra.allow
...
class TaskResultPolicyGuardScopeRead(BaseModel):
    class Config:
        extra = Extra.allow
...
class DataGeneratorLibSchemasSchemaOpalDataDerivedRole(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    rules: List[DataGeneratorLibSchemasSchemaOpalDataDerivedRoleRule] = Field(
        ..., description='List of rules for the derived role.', title='Rules'
    )


class DataGeneratorLibSchemasSchemaOpalDataResourceTypeData(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    derived_roles: Dict[str, DataGeneratorLibSchemasSchemaOpalDataDerivedRole] = Field(
        ...,
...
class PermitBackendSchemasSchemaOpalDataDerivedRole(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    rules: List[PermitBackendSchemasSchemaOpalDataDerivedRoleRule] = Field(
        ..., description='List of rules for the derived role.', title='Rules'
    )


class PermitBackendSchemasSchemaOpalDataResourceTypeData(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    derived_roles: Dict[str, PermitBackendSchemasSchemaOpalDataDerivedRole] = Field(
        ...,
        description='Key-Value mapping of the derived roles for the resource type.\nThe key is the derived role key and the value is the details and conditions for the role derivation.',
        title='Derived Roles',
    )
...
class PaginatedResultRelationshipTupleDetailedRead(BaseModel):
    ...
    data: List[RelationshipTupleDetailedRead] = Field(
...
class DataGeneratorLibSchemasSchemaOpalDataFullData(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    tenants: Dict[str, DataGeneratorLibSchemasSchemaOpalDataTenantData] = Field(
        ...,
    ...
    roles: Dict[str, DataGeneratorLibSchemasSchemaOpalDataRoleData] = Field(
        ...,
    ...
    resource_types: Dict[str, DataGeneratorLibSchemasSchemaOpalDataResourceTypeData] = (
        Field(
            ...,
    ...
    condition_sets: Dict[str, DataGeneratorLibSchemasSchemaOpalDataConditionSetData] = (
        Field(
            ...,
    ...
    role_permissions: Dict[
        str, Dict[str, DataGeneratorLibSchemasSchemaOpalDataRoleData]
    ] = Field(
        ...,
...
class PermitBackendSchemasSchemaOpalDataFullData(BaseModel):
    class Config:
        extra = Extra.allow
    ...
    tenants: Dict[str, PermitBackendSchemasSchemaOpalDataTenantData] = Field(
        ...,
        description='Key-Value mapping of the tenants in the system.\nThe key is the tenant key and the value contains some details about the tenant.',
        title='Tenants',
    )
    roles: Dict[str, PermitBackendSchemasSchemaOpalDataRoleData] = Field(
        ...,
        description='Key-Value mapping of the roles in the system.\nThe key is the role key and the value contains some details about the role.',
        title='Roles',
    )
    ...
    resource_types: Dict[str, PermitBackendSchemasSchemaOpalDataResourceTypeData] = (
        Field(
            ...,
            description='Key-Value mapping of the resource types in the system.\nThe key is the resource type key and the value contains some details about the resource type.',
            title='Resource Types',
    ...
    condition_sets: Dict[str, PermitBackendSchemasSchemaOpalDataConditionSetData] = (
        Field(
            ...,
            description='Key-Value mapping of the condition sets in the system.\nThe key is the formatted condition set key and the value contains some details about the condition set.',
            title='Condition Sets',
    ...
    role_permissions: Dict[
        str, Dict[str, PermitBackendSchemasSchemaOpalDataRoleData]
    ] = Field(
        ...,
        description='Key-Value mapping of the permissions for each role.\nThe key is the resource key and the value is Key-Value mapping of role key to details on the role permissions.',
        title='Role Permissions',
