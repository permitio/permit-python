...
#   timestamp: 2023-05-20T10:34:10+00:00
...
class AVPEngineDecisionLog(BaseModel):
    ...
    engine: Optional[Engine] = Field('AVP', title='Engine')
    timestamp: datetime = Field(..., title='Timestamp')
...
class ActivityDetailsObject(BaseModel):
    ...
    kind: Optional[Kind1] = Field('object', title='Kind')
...
class IsOnboarding(Enum):
    boolean_False = False


class OnboardingStep1(Enum):
    done = 'done'
...
class AuthnMeUserRead(BaseModel):
    ...
    actor_type: Optional[ActorType2] = Field('user', title='Actor Type')
    id: UUID = Field(..., title='Id')
    key: str = Field(..., title='Key')
    org_id: UUID = Field(..., title='Org Id')
    project_id: UUID = Field(..., title='Project Id')
    ...
    is_onboarding: Optional[IsOnboarding] = Field(False, title='Is Onboarding')
    onboarding_step: Optional[OnboardingStep1] = Field('done', title='Onboarding Step')
...
class ElementsPermissionLevel(Enum):
    LEVEL_1 = 'LEVEL_1'
    LEVEL_2 = 'LEVEL_2'
    LEVEL_3 = 'LEVEL_3'
    LEVEL_4 = 'LEVEL_4'
...
class FullRegeneration(BaseModel):
    ...
    scope: Scope1 = Field(..., title='Scope')
...
class OrganizationRegeneration(BaseModel):
    ...
    scope: Scope2 = Field(..., title='Scope')
    org_id: UUID = Field(..., title='Org Id')
...
class ProjectRegeneration(BaseModel):
    ...
    scope: Scope3 = Field(..., title='Scope')
    org_id: UUID = Field(..., title='Org Id')
    proj_id: UUID = Field(..., title='Proj Id')
...
class SSHAuthData(BaseModel):
    ...
    auth_type: Optional[AuthType] = Field('ssh', title='Auth Type')
...
class ActivityDetailsList(BaseModel):
    ...
    kind: Optional[Kind] = Field('list', title='Kind')
    type: str = Field(..., title='Type')
...
class AuthnMeAPIKeyRead(BaseModel):
    ...
    actor_type: Optional[ActorType] = Field('api_key', title='Actor Type')
    id: UUID = Field(..., title='Id')
    object_type: MemberAccessObj
...
class AuthnMeMemberRead(BaseModel):
    ...
    actor_type: Optional[ActorType1] = Field('member', title='Actor Type')
    id: UUID = Field(..., title='Id')
    email: EmailStr = Field(
        ..., description='Email of the user controlling this account', title='Email'
    )
...
class OPAEngineDecisionLog(BaseModel):
    ...
    engine: Optional[Engine1] = Field('OPA', title='Engine')
    decision_id: UUID = Field(..., title='Decision Id')
    labels: OPALabels
    timestamp: datetime = Field(..., title='Timestamp')
    path: str = Field(..., title='Path')
