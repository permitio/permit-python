...
async def test_client_sync_user_create(api_client: PermitApiClient, email: str):
    create_user = UserCreate(key=email,
...
@pytest.mark.parametrize("email", ["name4@domain.com", "name5@domain.com", "name6@domain.com"])
async def test_client_sync_user_create_dict(api_client: PermitApiClient, email: str):
    create_user = UserCreate(key=email,
                             email=EmailStr(email),
                             first_name="test first name",
                             last_name="test last name").dict()
    user = await api_client.sync_user(create_user)
    created_user_dict = user.dict()
...
async def test_client_sync_user_update_dict(api_client: PermitApiClient, email: str):
    update_user = UserCreate(key=email,
                             email=EmailStr(email),
                             first_name="test first name updated",
                             last_name="test last name updated").dict()
...
async def test_client_sync_user_missing_key(api_client: PermitApiClient, email: str):
    create_user = UserCreate(key=email,
                             email=EmailStr(email),
                             first_name="test first name updated",
                             last_name="test last name updated").dict(exclude={"key"})
...
async def test_client_create_tenant(api_client: PermitApiClient, tenant_key: str):
    create_tenant = TenantCreate(key=tenant_key,
                                 name=tenant_key)
...
async def test_client_create_role(api_client: PermitApiClient, role_key: str):
    create_role = RoleCreate(key=role_key,
                             name=role_key)
...
@pytest.mark.parametrize(["role_key", "tenant_key", "user_key"],
                         [("role1", "tenant1", "name1@domain.com"),
                          ("role2", "tenant2", "name2@domain.com"),
                          ("role3", "tenant3", "name3@domain.com")])
async def test_client_assign_role(api_client: PermitApiClient,
                                  role_key: str, tenant_key: str, user_key: str):
...
@pytest.mark.parametrize(["role_key", "tenant_key", "user_key"],
                         [("role1", "tenant1", "name1@domain.com"),
                          ("role2", "tenant2", "name2@domain.com"),
                          ("role3", "tenant3", "name3@domain.com")])
async def test_client_unassign_role(api_client: PermitApiClient,
                                    role_key: str, tenant_key: str, user_key: str):
...
@pytest.mark.parametrize("email", ["name1@domain.com", "name2@domain.com", "name3@domain.com",
                                   "name4@domain.com", "name5@domain.com", "name6@domain.com"])
